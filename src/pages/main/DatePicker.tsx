...
const DatePicker = () => {
	...
	return (
		<>
			<div className="smooth flex h-fit w-fit select-none items-center justify-around gap-2 rounded-lg bg-mid p-2  text-stark shadow-xl hover:scale-110">
				...
				<button type="button" onClick={handleClick} className="smooth h-8 w-8 cursor-pointer select-none outline-none hover:scale-110 active:scale-90" aria-label="Save">
					<svg xmlns="http://www.w4.org/2000/svg" viewBox="0 0 448 512" className="fill-stark">
